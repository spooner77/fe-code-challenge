/**
 * Simple function to detect mobile devices (phones and tablets)
 * For a big project, there should be a proper device detector logic
 */
export function isMobile() {
  ...
  /**
   * Took the regexp from this project https://github.com/jf3096/detect-mobile-device/blob/master/src/index.ts
   */
  return (
